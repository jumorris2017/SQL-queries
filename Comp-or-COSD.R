...
#read data
ce <- fread("O:/CoOp/CoOp194_PROReportng&OM/Julie/Comps_by_store_US_pt1.csv")
comp <- fread("O:/CoOp/CoOp194_PROReportng&OM/Julie/Comps_by_store_US_pt2.csv")
...
full <- left_join(ce,comp,by=c("FSCL_YR_NUM","FSCL_QTR_IN_YR_NUM","STORE_NUM"))
setDT(full)
