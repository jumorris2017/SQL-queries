...
# #load data
# wp <- fread("O:/CoOp/CoOp194_PROReportng&OM/Julie/worth_perception_for_R_112817.csv")
# #load NYC store data
...
#load data
wp4 <- fread("O:/CoOp/CoOp194_PROReportng&OM/Julie/worth_perception_for_R_112817.csv")
#load NYC store data
nypz <- fread("O:/CoOp/CoOp194_PROReportng&OM/Julie/nycpricezonestore.csv")
nyvec <- unique(nypz[,store_num])
