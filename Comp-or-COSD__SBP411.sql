 ...
 SELECT ca.FSCL_YR_NUM
    ...
    FROM APPBUS.DFT_INTL_STORE_DAY_VW f      
        ...
        INNER JOIN APPBUS.AFT_STORE_COMP_PER_VW comp
            ...
            AND COMP_CODE = 'Y'
    GROUP BY f.STORE_NUMBER, ca.FSCL_YR_NUM, ca.FSCL_QTR_IN_YR_NUM --,org.RGN_ORG_LVL_DESCR
 ;
 ...
 SELECT ca.FSCL_YR_NUM
    ...
    FROM APPBUS.DFT_INTL_STORE_DAY_VW f      
        ...
        INNER JOIN APPBUS.AFT_STORE_COMP_PER_VW comp
            ...
            AND ca.FSCL_PER_BEG_DT = comp.FISCAL_PERIOD_BEGIN_DATE
            AND COMP_CODE = 'Y'
    GROUP BY ca.FSCL_YR_NUM, ca.FSCL_QTR_IN_YR_NUM,org.RGN_ORG_LVL_DESCR
 ;
