SELECT CAL_YR_NUM, STORE_NUM, AREA_ORG_LVL_VERS_SID, SUM(Q2_8_Response_Total) AS Q2_8_Response_Total, SUM(Q2_8_TB_Cnt) AS Q2_8_TB_Cnt, new_week 
...
GROUP BY
CAL_YR_NUM, STORE_NUM, AREA_ORG_LVL_VERS_SID, new_week
ORDER BY
