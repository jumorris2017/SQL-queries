...
dt <- fread(paste0(data_dir,"/2018-08-15_Pulse_Analysis_Labor_TaskEvolved.csv"))
...
write.csv(temp,paste0(data_dir,"/temp3.csv"))


#t-test function's p-values
...
tfunc(dt[JOB_ID==50000362&DAYPART=='MID'&TPERIOD=='0_PRE',AVG_SCORE],
      ...
      dt[JOB_ID==50000362&DAYPART=='MID'&TPERIOD=='1_POST',RESP_TOTAL])
